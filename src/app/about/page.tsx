    ...
    <div className="animate-fade-in">
      ...
      <section className="relative h-64 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-5xl font-serif mb-4">About SS Hair Studio</h1>
          <p className="text-gray-300 text-lg">Beauty designed around you in Bhayandar East</p>
        </div>
      </section>
      ...
      <div className="container py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <p className="text-muted mb-4">
              SS Hair Studio was founded with a single vision — to create a space where every person feels valued, 
              beautiful, and confident. We believe that great grooming isn't a luxury; it's a necessity.
            </p>
            <p className="text-muted mb-6">
              Located at Shop no. 3 Rashmi Laxmi Sadan, Opposite Mira Bhayandar Mahanagar Palika, Navghar Road, Bhayandar East, Thane, 
              our expert team brings years of experience in hair cuts, styling, facials, and specialized Honey & Rica waxing treatments.
            </p>
            <ul className="flex flex-col gap-3">
              {['Professional, certified stylists', 'Premium Honey & Rica Waxing products', 'Hygienic & sanitized environment', 'Personalised service for every client'].map(item => (
          ...
          <div className="relative h-80 rounded-lg overflow-hidden shadow-lg">
            <Image src="/hero.png" alt="SS Hair Studio Interior" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted">The principles that guide everything we do at SS Hair Studio</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            { icon: <Users size={32}/>, title: 'Inclusivity', text: 'SS Hair Studio is a welcoming space for everyone — all genders, ages, and backgrounds.' }
          ].map(v => (
